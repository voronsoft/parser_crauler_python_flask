...
class ParsedData(db.Model):
    """
    id - ...
    links_from_page - все ссылки с страницы сайта
    """
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    links_from_page = db.Column(db.Text, default='No urls from this page')  # Ссылки, также TEXT, чтобы хранить много данных
